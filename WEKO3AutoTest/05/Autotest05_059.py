...
def run(playwright):
    ...
    page.click("//*[local-name()=\"svg\" and normalize-space(.)='Addthis' and normalize-space(@title)='More' and normalize-space(@role)='img']")

    with page.expect_popup() as popup_info:
        page.click(".at-icon.at-icon-gmail g path")
    page1 = popup_info.value

    # Click input[name="email"]
    page1.click("text=/.*ログイン.*/")

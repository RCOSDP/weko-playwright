...
def run(playwright):
    ...
    # Click //a[normalize-space(.)='Setting']
    page.click("//a[normalize-space(.)='Setting']")

    # Click text="Index Link"
    page.click("text=\"Index Link\"")
    # assert page.url == "https://localhost/admin/indexlink/"

    # Click text=/.*Disable.*/ >> input[name="indexlink"]
    page.click("text=/.*Enable.*/ >> input[name=\"indexlink\"]")

    # Click //button[normalize-space(.)='  Update']/span
    # page.click("//button[normalize-space(.)='  Update']/span")
    page.click('//*[@id="index_form_submit"]')
    # assert page.url == "https://localhost/admin/indexlink/"
    ...
    # Click text=/.*Disable.*/ >> input[name="indexlink"]
    page.click("text=/.*Disable.*/ >> input[name=\"indexlink\"]")

...
def run(playwright):
    ...
    #page.select_option("//div[normalize-space(.)='DetailSimplePreview']/select", "string:Simple")
    ...
    #page.select_option("//div[starts-with(normalize-space(.), 'write your own licenseCreative Commons CC0 1.0 Universal Public Domain Designati')]/select", "string:Creative Commons CC0 3.0")
    ...
    page.screenshot(path=f'{"Autotest05_243_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_256_1"}_capture.png')

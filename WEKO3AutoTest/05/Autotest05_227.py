...
def run(playwright):
    ...
    file_chooser.set_files("sample.wav")
    ...
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.doc")

    page.wait_for_timeout(int(SET_WAIT))

    page.screenshot(path=f'{"Autotest05_228_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_229_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.xls")

    page.wait_for_timeout(int(SET_WAIT))

    page.screenshot(path=f'{"Autotest05_230_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_231_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.ppt")

    page.wait_for_timeout(int(SET_WAIT))

    page.screenshot(path=f'{"Autotest05_232_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_233_1"}_capture.png')

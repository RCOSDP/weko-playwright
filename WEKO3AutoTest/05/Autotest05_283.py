...
def run(playwright):
    ...
    page.fill('//*[@id="app-author-search"]/div/div/div[1]/app-author-search/div/div/app-add-author/div[2]/div/div/div/div[3]/div/div[2]/div[1]/div/div[1]/input', "comadmin@example.org")
    ...
    page.screenshot(path=f'{"Autotest05_284_1"}_capture.png')

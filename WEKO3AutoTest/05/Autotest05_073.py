...
def run(playwright):
    ...
    # Click //a[normalize-space(.)='Files']
    page.click("//a[normalize-space(.)='Files']")

    # Click text="Location"
    page.click("text=\"Location\"")
    # assert page.url == "https://localhost/admin/location/"

    # Click //a[normalize-space(@title)='View Record']/span
    page.click("//a[normalize-space(@title)='View Record']/span")
    # assert page.url == "https://localhost/admin/location/details/?id=1&url=/admin/location/"

...
def run(playwright):
    ...
    file_chooser.set_files("sample.md")
    ...
    page.screenshot(path=f'{"Autotest05_213_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.json")
    ...
    page.screenshot(path=f'{"Autotest05_214_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.xmll")
    ...
    page.screenshot(path=f'{"Autotest05_215_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.csv")
    ...
    page.screenshot(path=f'{"Autotest05_216_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_217_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_218_1"}_capture.png')

    # Click text=/.*Click to select.*/
    with page.expect_file_chooser() as fc_info:
        page.click("text=/.*Click to select.*/")
    file_chooser = fc_info.value
    file_chooser.set_files("sample.jpg")
    ...
    page.screenshot(path=f'{"Autotest05_219_1"}_capture.png')

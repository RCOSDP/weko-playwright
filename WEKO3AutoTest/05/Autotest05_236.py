...
def run(playwright):
    ...
    # Click //label[normalize-space(.)='Registered User Only']/input[normalize-space(@type)='radio' and normalize-space(@name)='item_1617605131499.0.accessrole']
    page.click("//label[normalize-space(.)='Registered User Only']/input[normalize-space(@type)='radio' and normalize-space(@name)='item_1617605131499.0.accessrole']")

    page.wait_for_timeout(int(SET_WAIT))

    # Press ArrowDown : Preview
    ...
    page.screenshot(path=f'{"Autotest05_240_1"}_capture.png')

...
def run(playwright):
    ...
    # Click text="wekosoftware@nii.ac.jp"
    page.click("text=\"wekosoftware@nii.ac.jp\"")
    ...
    page.screenshot(path=f'{"Autotest05_294_1"}_capture.png')
    ...
    page.screenshot(path=f'{"Autotest05_297_1"}_capture.png')

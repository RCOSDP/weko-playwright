...
def run(playwright):
    ...
    # Click text="title"        
    #　一度編集すると、同じアイテムは編集できなくなるので「div[9]/div[1]/div/a"」のdiv[9]の値を変更すること
    page.click("//*[@id='index_item_list']/div[2]/div/div/invenio-search-results/div[9]/div[1]/div/a")
    ...
    page.press('//*[@id="weko-records"]/invenio-files-uploader/invenio-records/div[2]/div[8]/invenio-records-form/div/div/form/bootstrap-decorator[3]/fieldset/div/div[2]/div/div[1]/ol/li[1]/sf-decorator/div/sf-decorator[2]/div/div/select', "ArrowDown")
    ...
    # Click text=/.*Next.*/
    # with page.expect_navigation(url="https://localhost/workflow/iframe/success"):

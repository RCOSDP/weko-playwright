...
def run(playwright):
    ...
    # Check //div[normalize-space(.)='Index C(No OAI-PMH)']/div[2]/input[normalize-space(@type)='checkbox']
    page.check("//div[normalize-space(.)='Index C(No OAI-PMH)']/div[2]/input[normalize-space(@type)='checkbox']")
